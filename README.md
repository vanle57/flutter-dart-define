...
Dart defines là các biến được tạo ra trong khoảng thời gian biên dịch chương trình (_compile-time variables_). Nếu bạn đang tìm kiếm những biến tương tự biến môi trường (_environtment variables_) thì Dart defines là những gì bạn cần! Và nó được tạo ra bởi câu lệnh `--dart-define`.
